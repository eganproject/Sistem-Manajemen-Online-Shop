...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
  @if (request()->is('dashboard/penjualan/showpenjualannamakategoripenjualan/' . $id))
  <h1 class="h2">Penjualan dari {{ $nama }}</h1>
  @else
  <h1 class="h2">Penjualan {{ $namaproduk }}</h1>
  @endif
</div>
<div class="row col-lg-10">
  <div class="col-lg-4">
    <form action="
    @if (request()->is('dashboard/penjualan/showpenjualannamakategoripenjualan/' . $id))
    /dashboard/penjualan/showpenjualannamakategoripenjualan/{{ $id }}
    @else
    /dashboard/penjualan/showpenjualanproduk/{{ $id }}
    @endif
    ">
        @csrf
        ...
        <tbody>
           ...
           @endphp
            <tr>
                ...
                <td>
                    @if ($penjualan->VariasiProdukOption == null)
                   {{ $penjualan->nonVariasiProduk->Produk->namaproduk }}
                    @else
                   {{ $penjualan->VariasiProdukOption->VariasiProduk->Produk->namaproduk .' - '. $penjualan->VariasiProdukOption->namavariasioption }}
                    @endif
                </td>
                <td 
                ...
                <td>{{ $penjualan->KategoriPenjualan->namakategoripenjualan }}</td>
