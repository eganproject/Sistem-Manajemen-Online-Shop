...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
  @if (request()->is('dashboard/barangmasuk/showbarangmasuknamasumber/' . $id))
    <h1 class="h2">Barang Masuk dari {{ $nama }}</h1>
    @else
    <h1 class="h2">Barang Masuk {{ $namaproduk }}</h1>
...
<div class="row col-lg-10">
    <div class="col-lg-4">
      <form action="
      @if (request()->is('dashboard/barangmasuk/showbarangmasuknamasumber/' . $id))
      /dashboard/barangmasuk/showbarangmasuknamasumber/{{ $id }}
      @else
      /dashboard/barangmasuk/showbarangmasukproduk/{{ $id }}
      @endif
      ">  
      @csrf
        ...
        <tbody>
          ...
          @endphp
            <tr>
                ...
                <td>{{ $bm->SumberBarang->namasumber }}</td>
